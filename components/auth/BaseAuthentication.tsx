  ...
  return (
    <>
      <div className='flex justify-between space-x-4'>
        <Button
          className='flex items-center bg-[#E6E6E680] p-6 text-sm font-bold text-black hover:bg-[#dedbdb]'
        ...
        <Button
          ...
          className='flex items-center bg-[#E6E6E680] py-6 text-sm font-bold text-black ring-[unset] hover:bg-[#dedbdb]'
